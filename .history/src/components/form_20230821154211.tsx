      ...
      <form>
        <fieldset>
          ...
          <div className="checkbox">
            <input type="number" name="dual-salary" id="dual-salary"  min={1} max={1000} defaultValue={1} maxLength={4} />
            <label htmlFor="dual-salary">How many persons are contributing to the purchasing the house?</label>
          </div>
