    ...
    <>
      ...
      <form>
        <fieldset>
          ...
          <div className="persons" style={{ display: "flex" }}>
            <div className="person">
              <input type="number" name="Salary1" id="salary1"  value={formData.persons[0].salary} min={1} max={99999999999} />
                          <label htmlFor="salary" >Your Monthly Income</label>
              <input type="number" name="birthYear1" id="birthYear1" value={formData.persons[0].birthYear} />
        ...
        <fieldset>
          ...
          <input type="Housing Cost" name="cost" id="cost" value={formData.housingCost} onChange={} />
