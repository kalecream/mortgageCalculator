...
const Form = () => {
    ...
    useEffect(() => {
        let housingCost = formData.housingCost;
        let borrowAmount = housingCost - formData.persons[0]?.downPayment;
        let borrowAmountAfterNHT = borrowAmount - formData.nhtMax;
    ...
    }, [formData.housingCost, formData.persons[0]?.downPayment, formData.nhtMax]);
