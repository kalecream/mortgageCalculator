...
const Form = () => {
    ...
    const onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        newFormData.persons[0]['name'] = Number(value);
      ...
      <form>
        <fieldset>
          ...
          <div className="checkbox">
            <input type="number" name="dual-salary" id="dual-salary"  min={1} max={1000} defaultValue={1} maxLength={4} onChange={onChange} value={formData.} />
